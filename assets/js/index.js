...
document.addEventListener("click", (e) => {
    ...
    if (e.target.id == "Ojo") {
        const borderImg = document.getElementById("Ojo");
    ...
    if (e.target.id == "btn-verificar") {
        ...
        const num4 = document.querySelector("#card-4");

        if (validarInput(num1) && validarInput(num2) && validarInput(num3) && validarInput (num4)) {
            const suma = Number(num1.value) + Number(num2.value) + Number(num3.value) + Number (num4.value);
